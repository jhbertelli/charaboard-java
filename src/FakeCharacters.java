public class FakeCharacters {
    public static Character[] getFakeCharacters() {
        ...
        Character redPokemon = new Character(
                "Red",
                20,
        ...
        Character laraCroft = new Character("Lara Croft",
                21,
        ...
        return new Character[] {
                flandreScarlet,kratos,laraCroft,redPokemon,character3,character1,character2,solidSnake
        };
    }
}
